...
For CTmax boxplots, we'll focus on just individuals with body sizes larger than 0.72 mm. This is a temporary arbitrary cut-off based on where the breaks in body size data appeared. 
